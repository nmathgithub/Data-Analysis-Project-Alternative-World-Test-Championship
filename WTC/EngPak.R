...
winner = res[[3]][[34]]
home = res[[1]][[34]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[34]]; #away = gsub(" ", "", away, fixed = TRUE); 
# 32-34 for Eng-Pak
...
#1st Test 
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1198241.html")
#2nd Test 
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1198242.html")
#3rd Test 
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1198243.html")
...
# testtea = rbind(testtea[1:2,], testend[2,], testlunch[4,], testtea[3,])
# 3rd Test - Day 4  Rain 
testtea = rbind(testtea[1:3,], testlunch[4,], testtea[4,])
...
testfinn[[1]] = away; #1st and 3rd Test 
# testfinn[[1]] = home #2nd Test
print(testfinn)
