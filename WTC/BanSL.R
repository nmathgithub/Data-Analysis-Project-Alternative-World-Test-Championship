...
winner = res[[3]][[58]]
home = res[[1]][[58]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[58]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test Pallekele
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1255828.html")
#2nd Test Pallekele
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1255829.html")
...
# 1ST TEST 
# testinn = rbind(testinn[1,], testlunch[5,])
# 2ND TEST (missing data + couple of declarations)
decl1 = c('Lanka', 493, 7, 159.2)
decl2 = c('Lanka', 194, 9, 42.2)
testinn = rbind(decl1, testinn[1,], decl2)
