...
winner = res[[3]][[35]]
home = res[[1]][[35]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[35]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test 
 scorecard = readLines("https://espncricinfo.com/ci/engine/match/1233957.html")
#2nd Test
#scorecard = readLines("https://espncricinfo.com/ci/engine/match/1233958.html")
