...
winner = res[[3]][[22]]
home = res[[1]][[22]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[22]]; #away = gsub(" ", "", away, fixed = TRUE); 
#18, 20, 22 for Aus-NZ 
...
#1st Test 
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1183532.html")
#2nd Test  1183534 
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1183533.html")
# FOR 2ND TEST, ALL 0.5* REMOVED 
#3rd Test
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1183534.html")
