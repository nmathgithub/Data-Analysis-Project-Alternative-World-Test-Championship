...
winner = res[[3]][[51]]
home = res[[1]][[51]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[51]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test Karachi
#scorecard = readLines("https://espncricinfo.com/ci/engine/match/1244025.html")
#2nd Test Rawalpindi
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1244026.html")
...
#1ST TEST (Day 2 Tea -> End of 1st Innings)
# testinn = rbind(testtea[2,], testinn)
