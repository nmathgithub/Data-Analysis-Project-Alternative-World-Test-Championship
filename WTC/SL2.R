...
winner = res[[3]][[4]]
home = res[[1]][[4]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, etc.
away = res[[2]][[4]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
scorecard = readLines('https://www.espncricinfo.com/series/icc-world-test-championship-2019-2021-1195334/sri-lanka-vs-new-zealand-2nd-test-1192874/full-scorecard')
