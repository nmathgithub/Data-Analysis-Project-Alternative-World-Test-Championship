...
winner = res[[3]][[46]]
home = res[[1]][[46]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[46]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test Galle
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1243015.html")
#2nd Test Galle
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1243016.html")
...
for(x in 1:(0.5*length(tea0[[1]]))){
  ...
  tea11 = gsub('-', '\\1', substring(scorecard[out2],tea0[[1]][[x]] +5, tea0[[1]][[x]]+28))
