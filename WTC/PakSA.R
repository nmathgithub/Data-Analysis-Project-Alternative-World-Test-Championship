...
winner = res[[3]][[49]]
home = res[[1]][[49]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[49]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test Karachi
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1243017.html")
#2nd Test Rawalpindi
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1243018.html")
...
# 1ST TEST - Error in Data
# err1 = c('Pakistan', 378, 10, 119.2);
# testinn = rbind(testinn[1,], err1, testinn[2,])
