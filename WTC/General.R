...
winner = res[[3]][[2]]
home = res[[1]][[2]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, etc.
away = res[[2]][[2]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#scorecard = readLines('https://www.espncricinfo.com/series/icc-world-test-championship-2019-2021-1195334/england-vs-australia-4th-test-1152849/full-scorecard')
...
scorecard = readLines('https://www.espncricinfo.com/series/icc-world-test-championship-2019-2021-1195334/sri-lanka-vs-new-zealand-1st-test-1192873/full-scorecard')
...
for(x in 1:(0.5*length(lunch0[[1]]))){
  ...
  lunch11 = gsub('-', '\\1', substring(scorecard[out1],lunch0[[1]][[x]] +7, lunch0[[1]][[x]]+33))
...
# Lunch day 4 and end of innings collide:
