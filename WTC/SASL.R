...
winner = res[[3]][[42]]
home = res[[1]][[42]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[42]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test Centurion
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1237356.html")
#2nd Test Johannesburg
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1237357.html")
