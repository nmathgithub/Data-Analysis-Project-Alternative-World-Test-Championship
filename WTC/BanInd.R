...
winner = res[[3]][[15]]
home = res[[1]][[15]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[15]]; #away = gsub(" ", "", away, fixed = TRUE); 
# 13,15 for India-Bangladesh  
...
#1st Test 
#scorecard = readLines('https://www.espncricinfo.com/series/icc-world-test-championship-2019-2021-1195334/india-vs-bangladesh-1st-test-1187016/full-scorecard')
#2nd Test 
scorecard = readLines('https://www.espncricinfo.com/series/icc-world-test-championship-2019-2021-1195334/india-vs-bangladesh-2nd-test-1187017/full-scorecard')
...
# testinn = rbind(testinn[1,],testend[2,], testinn[2,]) #Needed for 1st  tests
print(testinn)
...
days = 3; # Match ends between start of session and lunch
