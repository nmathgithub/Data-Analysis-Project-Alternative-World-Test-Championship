...
winner = res[[3]][[41]]
home = res[[1]][[41]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[41]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test Mt. Maunganaui
#scorecard = readLines("https://espncricinfo.com/ci/engine/match/1233962.html")
#2nd Test Christchurch
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1233963.html")
...
#1st Test 
# testinn = rbind(testinn[1,], testend[3,], testinn[2,])
#2nd Test 
testinn = rbind(testend[1,], testinn)
