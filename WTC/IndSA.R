...
winner = res[[3]][[12]]
home = res[[1]][[12]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[12]]; #away = gsub(" ", "", away, fixed = TRUE); 
# 10-12 for India-South Africa se 
...
#1st Test 
#scorecard = readLines('https://www.espncricinfo.com/series/icc-world-test-championship-2019-2021-1195334/india-vs-south-africa-1st-test-1187007/full-scorecard')
#2nd Test
# scorecard = readLines('https://www.espncricinfo.com/series/icc-world-test-championship-2019-2021-1195334/india-vs-south-africa-2nd-test-1187008/full-scorecard')
#3rd Test
scorecard = readLines('https://www.espncricinfo.com/series/icc-world-test-championship-2019-2021-1195334/india-vs-south-africa-3rd-test-1187009/full-scorecard')
#Match Result Data
out0 = grep('won', scorecard)
result0 = gregexpr('won', scorecard[out0])
print(substring(scorecard[out0], result0[[1]][[1]]-15, result0[[1]][[1]]+15))
...
# testinn = rbind(testend[3,], testinn) # Needed for Test 2  
