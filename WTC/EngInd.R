...
winner = res[[3]][[54]]
home = res[[1]][[54]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[54]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test Chennai
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1243384.html")
#2nd Test Chennai
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1243385.html")
#3rd Test Ahmedabad
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1243386.html")
#4th Test 
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1243387.html")
...
for(x in 1:(0.5*length(lunch0[[1]]))){
  ...
  lunch11 = gsub('-', '\\1', substring(scorecard[out1],lunch0[[1]][[x]] +4, lunch0[[1]][[x]]+32)) #Start from +4 for 3RD TEST
...
for(x in 1:(0.5*length(end0[[1]]))){
  ...
  end11 = gsub('-', '\\1', substring(scorecard[out3], end0[[1]][[x]] + 11, end0[[1]][[x]]+38))
