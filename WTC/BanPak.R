...
winner = res[[3]][[26]]
home = res[[1]][[26]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[26]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test 
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1213062.html")
