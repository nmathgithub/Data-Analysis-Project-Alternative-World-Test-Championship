...
winner = res[[3]][[25]]
home = res[[1]][[25]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[25]]; #away = gsub(" ", "", away, fixed = TRUE); 
# 21,23, 24, 25 for Eng-SA
...
#1st Test 
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1185304.html")
#2nd Test  1183534 
#scorecard = readLines("https://espncricinfo.com/ci/engine/match/1185305.html")
# FOR 2ND TEST, ALL 0.5* REMOVED 
#3rd Test
# scorecard = readLines("https://espncricinfo.com/ci/engine/match/1185306.html")
#4th Test 1185307
scorecard = readLines("https://espncricinfo.com/ci/engine/match/1185307.html")
