...
winner = res[[3]][[19]]
home = res[[1]][[19]]; #home = gsub(" ", "", home, fixed = TRUE); #Removes spaces in Sri Lanka, New Zealand, South Africa, West Indies, etc.
away = res[[2]][[19]]; #away = gsub(" ", "", away, fixed = TRUE); 
...
#1st Test 
#scorecard = readLines("https://espncricinfo.com/ci/engine/match/1206635.html")
#2nd Test 1183531
 scorecard = readLines("https://espncricinfo.com/ci/engine/match/1206636.html")
...
# print(lunch) #Incorrect Data 
testlunch = as.data.frame(matrix(lunch, ncol=4, byrow = TRUE))
names(testlunch) = c('Team', 'Runs', 'Wickets', 'Overs')
# testlunch[4,] = testlunch[5,]; testlunch[5,] = testlunch[6,]; testlunch = testlunch[1:5,] 1st Test 
print(testlunch)
...
#Fix tea data
# testtea = rbind(testtea[1,], testlunch[2,], testtea[2,], testlunch[4,], testtea[3,]) 1st Test 
print(testtea)
...
# testend = rbind(testend[1:4], testinn[2,]) 1st Test 
print(testend)
...
testfinn[[1]] = home; #Test1 
print(testfinn)
testinn[length(testinn[[1]])+1,] = testfinn[1,] # Test1 
